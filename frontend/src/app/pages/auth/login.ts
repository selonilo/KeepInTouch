    ...
    template: `
        ...
        <div class="bg-surface-50 dark:bg-surface-950 flex items-center justify-center min-h-screen min-w-[100vw] overflow-hidden">
            <div class="flex flex-col items-center justify-center">
                <span class="text-muted-color font-medium mb-2" routerLink="/auth/register" style="cursor: pointer">Üye ol</span>
                <div style="border-radius: 56px; padding: 0.3rem; background: linear-gradient(180deg, var(--primary-color) 10%, rgba(33, 150, 243, 0) 30%)">
                    <div class="w-full bg-surface-0 dark:bg-surface-900 py-20 px-8 sm:px-20" style="border-radius: 53px">
                        <div class="text-center mb-8">
                            ...
                            <div class="text-surface-900 dark:text-surface-0 text-3xl font-medium mb-4">Keep In Touch Hoşgeldiniz!</div>
                            <span class="text-muted-color font-medium">Devam etmek için giriş yapın</span>
                        </div>

                        <div>
                            <label for="email1" class="block text-surface-900 dark:text-surface-0 text-xl font-medium mb-2">Email</label>
                            <input pInputText id="email1" type="text" placeholder="Email adresi" class="w-full md:w-[30rem] mb-8" [(ngModel)]="mail" />
                            ...
                            <div class="flex items-center justify-between mt-2 mb-8 gap-8">
                                ...
                                <span class="font-medium no-underline ml-2 text-right cursor-pointer text-primary" routerLink="/auth/refresh-password">Şifremi unuttum?</span>
                            </div>
                            <p-button label="Giriş yap" styleClass="w-full" (onClick)="login()"></p-button>
                        </div>
                    </div>
                </div>
            </div>
